...
def main():
    ...
    domain = input("Quel domaine veux-tu utiliser ? (Par défaut: example.com) ") or "example.com"
    password_length = int(input("Longueur du mot de passe ? (Par défaut: 10) ") or 10)
